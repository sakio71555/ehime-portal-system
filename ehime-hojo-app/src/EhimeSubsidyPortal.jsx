...
const PURPOSE_LANDING_PAGES = [
  ...
  },
  {
    ...
    title: '愛媛県のIT導入補助金・業務ソフト導入支援',
    description:
      '愛媛県内でIT導入、業務ソフト、クラウドツール、ホームページ制作、EC、予約管理、会計、顧客管理などを検討する事業者向けの補助金・助成金をまとめています。',
    keywords: [
      'IT導入',
      'IT',
      'ソフトウェア',
  ...
  {
    slug: 'ai',
    title: '愛媛県のAI導入・生成AI活用補助金',
    description:
      '愛媛県内でAI導入、生成AI活用、業務自動化、デジタル化、制作効率化を検討する事業者向けの補助金・助成金を探せます。',
    keywords: [
      'AI',
      '生成AI',
      '人工知能',
  ...
  },
  {
    ...
    title: '愛媛県の個人事業主・フリーランス向け補助金',
    description:
      '愛媛県内の個人事業主・フリーランス・小規模事業者が確認したい補助金・助成金をまとめています。創業、IT導入、販路開拓、設備投資、デジタル化などの支援制度を探せます。',
    keywords: [
      '個人事業主',
      'フリーランス',
      '小規模事業者',
